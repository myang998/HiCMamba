...
def spreadM(c_mat, compact_idx, full_size, convert_int=True, verbose=False, fn='speadM_res.data'):
    """
    ...
    print(out_fn)
    result = np.memmap(str(fn), dtype=c_mat.dtype, mode='w+', shape=(full_size, full_size))
