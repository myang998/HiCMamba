...
if __name__ == '__main__':
    ...
    parser.add_argument('-md', '--model-name', type=str, default='Uformer')
    ...
    for n in tqdm(chr_list):
        ...
        in_file = os.path.join(data_dir, f'{model}_predict_chr{n}_40kb.npz')
        # in_file = os.path.join(data_dir, f'{model}_raw_chr{n}_40kb.npz')
        # in_file = os.path.join(data_dir, f'{model}_target_chr{n}_40kb.npz')
    ...
    cool_file = os.path.join(data_dir, f"{model}_predict_bound{bound}_40kb.cool")
    # cool_file = os.path.join(data_dir, f"{model}_raw_bound{bound}_40kb.cool")
    # cool_file = os.path.join(data_dir, f"target_bound{bound}_40kb.cool")
