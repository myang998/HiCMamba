...
import numpy as np
from data_processing.Insulation_score import compute_insulation_score, compute_boundaries
from Utils.data_utils import compactM, spreadM
...
class TAD:
    ...
    def __call__(self, data, idx):
        ...
        matrix = compactM(matrix, compact_idx, fn=f'kk{str(idx)}.dat')
