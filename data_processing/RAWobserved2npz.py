...
import os
import argparse
from Utils.data_utils import mkdir, readcoo2mat
...
def data_read_parser():
    ...
    req_args.add_argument('-c', default='GM12878', dest='cell_line', help='REQUIRED: Cell line for analysis[example:GM12878]',
                          required=False)
...
if __name__ == '__main__':
    ...
    pool_num = 1 if multiprocessing.cpu_count() > 23 else multiprocessing.cpu_count()

    raw_dir = f'D:/phd/project/3d_genome/HiCARN-master/Datasets_NPZ/raw/{cell_line}'
